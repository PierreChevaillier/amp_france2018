<?php
  ...
  // teste avec  : PHP 5.5.3 sur Mac OS 10.11 - php 7 serveur OVH
  ...
  class Zone_Partenaires extends Element_Page {
    ...
    public function initialiser() {
      ...
      $this->logos = ["logo_laot.png",
      "logo_eau_du_ponant.png",
      "logo_legall.png",
      "logo_legris.png",
      ...
      "carte_elise_affigliati.jpg",
      "carte_temps_beaute.png",
      "carte_apm.png",
      "carte_cachet_poste.png",
      "carte_creperie_plage.png",
      "carte_copy_concept.jpg",
      "carte_garage_lamour.png",
      "carte_lhostis.png",
      "carte_didier_benard.png",
      "carte_castrec.jpg",
      "carte_calvarin.png",
      ...
      "logo_joel_dreves.jpg",
      "logo_encre_bleue.png",
      "logo_etoile_ouest.png",
      "logo_locarmor.jpg",
      "logo_skoda.png",
