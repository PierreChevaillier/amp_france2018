...
class Bandeau_Partenaires extends Element_Page {
  ...
  protected function afficher_corps() {
    ...
    echo '<div class="col-sm-2" style="text-align:center;padding:5px;"><a href="http://www.pays-iroise.bzh"><img src="' . $this->chemin_dossier . '/logo_pays_iroise.png" style="height:100px;align:middle;" /></a></div>';
    echo '<div class="col-sm-2" style="text-align:center;padding:5px;"><a href="http://www.plougonvelin.fr"><img src="' . $this->chemin_dossier . '/logo_plougonvelin.png" style="height:100px;align:middle;" /></a></div>';
  }
