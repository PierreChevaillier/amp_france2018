<?php
  // ========================================================================
  // description : definition de la classe Contenu_Tourisme
  // utilisation : Liste de site web avec des informations sur le tourisme
 ...
 */
  class Contenu_Tourisme extends Element_Page {
    ...
    protected function afficher_corps() {
      echo "<h2>Informations touristiques</h2>\n";
