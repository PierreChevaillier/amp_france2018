<!DOCTYPE html>
  <html lang="fr">
    <?php
      ...
      $transport->nom_fichier_picto = "";
      $transport->def_titre("Pour venir en train");
      ...
      $transport->chemin_picto = $chemin_picto;
      $transport->nom_fichier_picto = "";
      $transport->def_titre("Pour venir en bus");
      $transport->contenu = "La Gare routière est située au centre ville, près de la gare SNCF. Des autocars au départ de la la gare de Brest permettent de rejoindre Plougonvelin, Le Conquet.";
      $liste_transports[] = $transport;

      $transport = new Information_Transport();
      $transport->chemin_picto = $chemin_picto;
      $transport->nom_fichier_picto = "";
      $transport->def_titre("Pour venir en avion");
      $transport->contenu = "L'aéroport le plus proche est celui de Brest Bretagne, situé à Guipavas. Un service de navettes permet de rejoindre le terminal du tram avec lequel on peut rejoindre le centre ville de Brest.";
      $liste_transports[] = $transport;
