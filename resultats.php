<!DOCTYPE html>
  <html lang="fr">
    <?php
      ...
      $texte = $texte . "<h2>Résultats de la Course longue distance  - dimanche 27 mai</h2><ul class=\"list-group\"><li class=\"list-group-item\"><a href=\"media/resultats/course_longue_distance.pdf\">Course longue distance</a></li></ul>";
