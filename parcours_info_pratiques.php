<!doctype html>
  <html lang="fr">
    <?php
      // =======================================================================
      // description : page web - affichage des informations pratiques sur
      //               le plan d'eau et les acces
      ...
      $page = new Page_France2018("parcours - informations pratiques");
      ...
      $media = new Cadre_Image("media/parcours/Championnat-France-Mer-2018_Informations-pratiques.png");
