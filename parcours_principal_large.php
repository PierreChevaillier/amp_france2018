<!doctype html>
  <html lang="fr">
    <?php
      // =======================================================================
      // description : page web - affichage du parcours principal en plan large
      ...
      $page = new Page_France2018("parcours principal - plan large");
      ...
      $media = new Cadre_Image("media/parcours/Championnat-France-Mer-2018_parcours-principal_plan-large.png");
      $media->def_titre("Parcours principal (plan large)");
