<!doctype html>
  <html lang="fr">
    <?php
      // =======================================================================
      // description : page web - affichage du parcours principal en plan serre
      ...
      $page = new Page_France2018("parcours principal en plan serré");
      ...
      $media = new Cadre_Image("media/parcours/Championnat-France-Mer-2018_parcours-principal_plan-serre.png");
      $media->def_titre("Parcours principal (plan serré)");
