...
<html lang="fr">
  <?php
    ...
    // -------------------------------------------------------------------------
    // creation : 30-oct-2017 pchevaillier@gmail.com
    // revision :
    // -----------------------------------------------------------------------
    // commentaires :
    // attention :
    ...
    $texte = "<p class=\"lead\">Votre demande a bien été enregistrée.</p><p class=\"lead\">Nous vous remercions pour votre message.</p>";
    $page_suivante = "index.php";
    $message = new Message_Confirmation($texte, $page_suivante);
    $message->def_titre("Demande d'information");
