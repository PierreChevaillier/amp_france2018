<!doctype html>
  <html lang="fr">
    <?php
      // =======================================================================
      // description : page web - affichage du parcours principal - dimanche
      // contexte    : site web du Championnat de France 2018
      // Copyright (c) 2017-2018 AMP. Tous droits reserves
      // -----------------------------------------------------------------------
      // creation : 25-avr-2018 pchevaillier@gmail.com
      // revision :
      // -----------------------------------------------------------------------
      // commentaires :
      // attention :
      ...
      $page = new Page_France2018("parcours de repli - Sud");
      ...
      $media = new Cadre_Image("media/parcours/parcours_dimanche_principal.png");
      $media->def_titre("Parcours Dimanche 27");
